...
static if (DEBUG_MODE) then
			...
			call AUnitInventory.init('I001', 'I000', 'A015', false, tre("Ausrüstungsfach wird bereits von einem anderen Gegenstand belegt.", "Equipment slot is already used by another item."), tre("%1% angelegt.", "Equipped %1%"), tre("Rucksack ist voll.", "Backpack is full."), tre("%1% in Tasche %2% verstaut.", "%1% put into bag %2%."), tre("Gegenstand konnte nicht verschoben werden.", "Item cannot be moved."), tre("Die Seitengegenstände können nicht abgelegt werden.", "The page items cannot be dropped."), tre("Die Seitengegenstände können nicht verschoben werden.", "The page items cannot be moved."), tre("Der Gegendstand gehört einem anderen Spieler.", "This item belongs to another player."), tre("Vorherige Seite ist bereits voll.", "Previous page is already full."), tre("Nächste Seite ist bereits voll.", "Next page is already full."))
			...
			call AVideo.init(tre("%s möchte das Video überspringen.", "%s wants to skip the video."), tre("Video wird übersprungen.", "Video has been skipped."))
			// world systems
