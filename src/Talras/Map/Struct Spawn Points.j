library StructMapMapSpawnPoints requires Asl, StructGameItemTypes, StructGameSpawnPoint
	...
	struct SpawnPoints
		// Dornheim
		private static VulnerableSpawnPoint m_chickensDornheim
		private static VulnerableSpawnPoint m_horses
		private static VulnerableSpawnPoint m_pigs
		private static VulnerableSpawnPoint m_ducksDornheim
		...
		private static method init0 takes nothing returns nothing
			...
			set thistype.m_chickensDornheim = VulnerableSpawnPoint.create()
			set index = thistype.m_chickensDornheim.addUnitWithType(gg_unit_n02X_0718, 1.0)
			set index = thistype.m_chickensDornheim.addUnitWithType(gg_unit_n02X_0715, 1.0)
			set index = thistype.m_chickensDornheim.addUnitWithType(gg_unit_n02X_0714, 1.0)
			set index = thistype.m_chickensDornheim.addUnitWithType(gg_unit_n02Y_0713, 1.0)

			set thistype.m_horses = VulnerableSpawnPoint.create()
			set index = thistype.m_horses.addUnitWithType(gg_unit_h03L_0126, 1.0)
			set index = thistype.m_horses.addUnitWithType(gg_unit_h03L_0009, 1.0)
			set index = thistype.m_horses.addUnitWithType(gg_unit_h03L_0142, 1.0)

			set thistype.m_pigs = VulnerableSpawnPoint.create()
			set index = thistype.m_pigs.addUnitWithType(gg_unit_n083_0762, 1.0)
			set index = thistype.m_pigs.addUnitWithType(gg_unit_n083_0761, 1.0)
			set index = thistype.m_pigs.addUnitWithType(gg_unit_n083_0756, 1.0)
			set index = thistype.m_pigs.addUnitWithType(gg_unit_n083_0757, 1.0)
			set index = thistype.m_pigs.addUnitWithType(gg_unit_n083_0760, 1.0)
			set index = thistype.m_pigs.addUnitWithType(gg_unit_n083_0758, 1.0)
			set index = thistype.m_pigs.addUnitWithType(gg_unit_n083_0759, 1.0)
			
			set thistype.m_ducksDornheim = VulnerableSpawnPoint.create()
			set index = thistype.m_ducksDornheim.addUnitWithType(gg_unit_n02N_0775, 1.0)
			set index = thistype.m_ducksDornheim.addUnitWithType(gg_unit_n02N_0776, 1.0)
			set index = thistype.m_ducksDornheim.addUnitWithType(gg_unit_n02N_0765, 1.0)
			set index = thistype.m_ducksDornheim.addUnitWithType(gg_unit_n02N_0766, 1.0)
			set index = thistype.m_ducksDornheim.addUnitWithType(gg_unit_n02N_0769, 1.0)
			set index = thistype.m_ducksDornheim.addUnitWithType(gg_unit_n02N_0770, 1.0)
			set index = thistype.m_ducksDornheim.addUnitWithType(gg_unit_n02N_0771, 1.0)
			set index = thistype.m_ducksDornheim.addUnitWithType(gg_unit_n02N_0763, 1.0)
			set index = thistype.m_ducksDornheim.addUnitWithType(gg_unit_n02N_0764, 1.0)

			set thistype.m_children = VulnerableSpawnPoint.create()
			set index = thistype.m_children.addUnitWithType(gg_unit_nvk2_0790, 1.0)
			set index = thistype.m_children.addUnitWithType(gg_unit_nvk2_0791, 1.0)
			set index = thistype.m_children.addUnitWithType(gg_unit_nvk2_0792, 1.0)
			set index = thistype.m_children.addUnitWithType(gg_unit_nvk2_0793, 1.0)
			set index = thistype.m_children.addUnitWithType(gg_unit_nvk2_0794, 1.0)
			set index = thistype.m_children.addUnitWithType(gg_unit_nvk2_0795, 1.0)
			set index = thistype.m_children.addUnitWithType(gg_unit_nvk2_0796, 1.0)
			set index = thistype.m_children.addUnitWithType(gg_unit_nvk2_0797, 1.0)
			set index = thistype.m_children.addUnitWithType(gg_unit_nvk2_0798, 1.0)
			set index = thistype.m_children.addUnitWithType(gg_unit_nvk2_0799, 1.0)
			set index = thistype.m_children.addUnitWithType(gg_unit_nvlk_0780, 1.0)
			set index = thistype.m_children.addUnitWithType(gg_unit_nvlk_0781, 1.0)
			set index = thistype.m_children.addUnitWithType(gg_unit_nvlk_0782, 1.0)
			set index = thistype.m_children.addUnitWithType(gg_unit_nvlk_0783, 1.0)
			set index = thistype.m_children.addUnitWithType(gg_unit_nvlk_0784, 1.0)
			set index = thistype.m_children.addUnitWithType(gg_unit_nvlk_0785, 1.0)
			set index = thistype.m_children.addUnitWithType(gg_unit_nvk2_0786, 1.0)
			set index = thistype.m_children.addUnitWithType(gg_unit_nvk2_0787, 1.0)
			set index = thistype.m_children.addUnitWithType(gg_unit_nvk2_0788, 1.0)
			set index = thistype.m_children.addUnitWithType(gg_unit_nvk2_0789, 1.0)
			set index = thistype.m_children.addUnitWithType(gg_unit_nvk2_0800, 1.0)

			set thistype.m_bagsAtTheTopMill = SpawnPoint.create()
			set index = thistype.m_bagsAtTheTopMill.addUnitWithType(gg_unit_n032_0708, 1.0)
			...
			set index = thistype.m_bagsAtTheTopMill.addUnitWithType(gg_unit_n031_0709, 1.0)
			call thistype.m_bagsAtTheTopMill.addNewItemType(index, 'I00B', 1.0)
			set index = thistype.m_bagsAtTheTopMill.addUnitWithType(gg_unit_n031_0710, 1.0)
			call thistype.m_bagsAtTheTopMill.addNewItemType(index, 'I00C', 1.0)

			set thistype.m_bagsAtTheBottomMill = SpawnPoint.create()
			set index = thistype.m_bagsAtTheBottomMill.addUnitWithType(gg_unit_n031_0772, 1.0)
			...
			set index = thistype.m_bagsAtTheBottomMill.addUnitWithType(gg_unit_n031_0773, 1.0)
			call thistype.m_bagsAtTheBottomMill.addNewItemType(index, 'I00B', 1.0)
			set index = thistype.m_bagsAtTheBottomMill.addUnitWithType(gg_unit_n032_0774, 1.0)
			call thistype.m_bagsAtTheBottomMill.addNewItemType(index, 'I00C', 1.0)

			set thistype.m_boxesAtWotansHouse = SpawnPoint.create()
			set index = thistype.m_boxesAtWotansHouse.addUnitWithType(gg_unit_n02C_0721, 1.0)
			...
			set index = thistype.m_boxesAtWotansHouse.addUnitWithType(gg_unit_n04B_0720, 1.0)
			call thistype.m_boxesAtWotansHouse.addNewItemType(index, 'I00D', 1.0)
			set index = thistype.m_boxesAtWotansHouse.addUnitWithType(gg_unit_n04B_0719, 1.0)
			call thistype.m_boxesAtWotansHouse.addNewItemType(index, 'I00A', 1.0)
			
			// Lettuce Heads
			call ItemSpawnPoint.createFromItemWithType( gg_item_I06U_0754, 1.0 )
			call ItemSpawnPoint.createFromItemWithType( gg_item_I06U_0752, 1.0 )
			call ItemSpawnPoint.createFromItemWithType( gg_item_I06U_0722, 1.0 )
			call ItemSpawnPoint.createFromItemWithType( gg_item_I06U_0729, 1.0 )
			call ItemSpawnPoint.createFromItemWithType( gg_item_I06U_0730, 1.0 )
			call ItemSpawnPoint.createFromItemWithType( gg_item_I06U_0724, 1.0 )
			call ItemSpawnPoint.createFromItemWithType( gg_item_I06U_0727, 1.0 )
			call ItemSpawnPoint.createFromItemWithType( gg_item_I06U_0726, 1.0 )
			call ItemSpawnPoint.createFromItemWithType( gg_item_I06U_0738, 1.0 )
			call ItemSpawnPoint.createFromItemWithType( gg_item_I06U_0747, 1.0 )
			call ItemSpawnPoint.createFromItemWithType( gg_item_I06U_0746, 1.0 )
			call ItemSpawnPoint.createFromItemWithType( gg_item_I06U_0741, 1.0 )
			call ItemSpawnPoint.createFromItemWithType( gg_item_I06U_0742, 1.0 )
			call ItemSpawnPoint.createFromItemWithType( gg_item_I06U_0743, 1.0 )
			call ItemSpawnPoint.createFromItemWithType( gg_item_I06U_0725, 1.0 )
			call ItemSpawnPoint.createFromItemWithType( gg_item_I06U_0737, 1.0 )
			call ItemSpawnPoint.createFromItemWithType( gg_item_I06U_0736, 1.0 )
			call ItemSpawnPoint.createFromItemWithType( gg_item_I06U_0739, 1.0 )
			call ItemSpawnPoint.createFromItemWithType( gg_item_I06U_0740, 1.0 )
			call ItemSpawnPoint.createFromItemWithType( gg_item_I06U_0748, 1.0 )
			call ItemSpawnPoint.createFromItemWithType( gg_item_I06U_0751, 1.0 )
			call ItemSpawnPoint.createFromItemWithType( gg_item_I06U_0749, 1.0 )
			call ItemSpawnPoint.createFromItemWithType( gg_item_I06U_0750, 1.0 )
			call ItemSpawnPoint.createFromItemWithType( gg_item_I06U_0745, 1.0 )
			call ItemSpawnPoint.createFromItemWithType( gg_item_I06U_0744, 1.0 )
			call ItemSpawnPoint.createFromItemWithType( gg_item_I06U_0731, 1.0 )
			call ItemSpawnPoint.createFromItemWithType( gg_item_I06U_0732, 1.0 )
			call ItemSpawnPoint.createFromItemWithType( gg_item_I06U_0733, 1.0 )
			call ItemSpawnPoint.createFromItemWithType( gg_item_I06U_0734, 1.0 )
			call ItemSpawnPoint.createFromItemWithType( gg_item_I06U_0753, 1.0 )
			call ItemSpawnPoint.createFromItemWithType( gg_item_I06U_0723, 1.0 )
			call ItemSpawnPoint.createFromItemWithType( gg_item_I06U_0735, 1.0 )
			...
			call thistype.m_highwaymen0.addItemType(index, itemIndex, 'I049', 0.50)
			call thistype.m_highwaymen0.addItemType(index, itemIndex, 'I04D', 0.50)
			set index = thistype.m_highwaymen0.addUnitWithType(gg_unit_n00T_0805, 1.0)
			set itemIndex = thistype.m_highwaymen0.addNewItemType(index, 'I00S', 0.50)
			call thistype.m_highwaymen0.addItemType(index, itemIndex, 'I00T', 0.50)
			call thistype.m_highwaymen0.addItemType(index, itemIndex, 'rhe2', 0.50)
			call thistype.m_highwaymen0.addItemType(index, itemIndex, 'rman', 0.50)
