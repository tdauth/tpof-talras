library StructMapMapSpawnPoints requires Asl, StructGameItemTypes, StructGameSpawnPoint
	...
	struct SpawnPoints
		...
		private static method init0 takes nothing returns nothing
			...
			set index = thistype.m_chickensDornheim.addUnitWithType(gg_unit_n02X_0101, 1.0)
			set index = thistype.m_chickensDornheim.addUnitWithType(gg_unit_n02X_0103, 1.0)
			set index = thistype.m_chickensDornheim.addUnitWithType(gg_unit_n02Y_0100, 1.0)
			set index = thistype.m_chickensDornheim.addUnitWithType(gg_unit_n02X_0102, 1.0)
			...
			set index = thistype.m_ducksDornheim.addUnitWithType(gg_unit_n02N_0105, 1.0)
			set index = thistype.m_ducksDornheim.addUnitWithType(gg_unit_n02N_0107, 1.0)
			set index = thistype.m_ducksDornheim.addUnitWithType(gg_unit_n02N_0106, 1.0)
			set index = thistype.m_ducksDornheim.addUnitWithType(gg_unit_n02N_0064, 1.0)
			set index = thistype.m_ducksDornheim.addUnitWithType(gg_unit_n02N_0109, 1.0)
			set index = thistype.m_ducksDornheim.addUnitWithType(gg_unit_n02N_0110, 1.0)
			set index = thistype.m_ducksDornheim.addUnitWithType(gg_unit_n02N_0104, 1.0)
			set index = thistype.m_ducksDornheim.addUnitWithType(gg_unit_n02N_0108, 1.0)
			set index = thistype.m_ducksDornheim.addUnitWithType(gg_unit_n02N_0112, 1.0)
			set index = thistype.m_ducksDornheim.addUnitWithType(gg_unit_n02N_0113, 1.0)
			set index = thistype.m_ducksDornheim.addUnitWithType(gg_unit_n02N_0124, 1.0)
